...
version: v4
role: implementation
description: Inspect the repository through repeated Safeplane MCP tool turns, then return exact plan-bound replacements within deterministic line and hunk budgets.
provenance:
  derived_from:
    - source: app.zip
      paths:
